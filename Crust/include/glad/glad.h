/*
    ...
    OpenGL loader generated by glad 0.1.33 on Mon Nov 18 17:34:14 2019.
...
typedef void (APIENTRYP PFNGLDRAWELEMENTSPROC)(GLenum mode, GLsizei ElementCount, GLenum unsignedInt, const void *offsetBytes);
...
typedef void (APIENTRYP PFNGLTEXSUBIMAGE2DPROC)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void *pix_offset);
...
typedef void (APIENTRYP PFNGLTEXSTORAGE2DPROC)(GLenum target, GLsizei levels, GLenum sizedInternalformat, GLsizei width, GLsizei height);
